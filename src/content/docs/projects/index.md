...
Four of the five tools are open source, which means the code is public and free to run, adapt, and inspect, so every claim on their pages can be checked against the code itself. The fifth is [80x](/projects/80x/), the commercial product these docs sit alongside. It gets the same honest architectural treatment and is clearly labeled as the one product page in the section.
...
| [awesome-attio](/projects/awesome-attio/) | A maintained list of Attio resources: official docs, developer tools, guides, and marketplace integrations, each checked and described in one line |
