...
| [Projects](/projects/) | One page per free, open-source tool: [valentine](/projects/valentine/), [attio-cli](/projects/attio-cli/), the [Attio Workflows Handbook](/projects/attio-workflows-handbook/), [awesome-attio](/projects/awesome-attio/), and [80x](/projects/80x/) itself | You want a tool you can install today, like a pre-call brief on your fund's prior contact |
